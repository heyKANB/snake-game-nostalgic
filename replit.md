...
**Latest Update (2025-08-12)**: Version 8.2.8 - Added ATT privacy settings management with build 20 ready for submission
...
- UPDATED: iOS Info.plist CFBundleVersion to "20" and CFBundleShortVersionString to "8.2.8"
- UPDATED: Codemagic.yaml build script to set version 20 in both project.pbxproj and Info.plist
