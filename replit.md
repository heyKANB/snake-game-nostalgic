...
**Latest Update (2025-08-05)**: Version 1.4.0 - Fixed production API connectivity for App Store deployment
...
- Updated iOS app version to 1.4.0 (build 5) and Android version 1.4.0 (build 5) with production API connectivity fixes
