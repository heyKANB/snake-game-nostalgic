...
**Latest Update (2025-08-06)**: Version 8.2.1 - Fixed TestFlight leaderboard connectivity
...
- UPDATED: iOS Info.plist CFBundleVersion to "11" and CFBundleShortVersionString to "8.2.1" 
- UPDATED: Codemagic.yaml build script to set version 11 in both project.pbxproj and Info.plist
